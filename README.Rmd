...
As of version 1.0.2, the package includes over 20 functions for pulling player and team data, game results, advanced metric splits, play-by-play shooting, and more.As of version 1.0.2, `toRvik` ships with more than 20 functions.
